...
try {
	...
	cout << "The following operators are avaible:\n";
	cout << "+ - / * % ( )\n";
	cout << "Avaible predefineds:\npi e k\n";
	cout << "type '" << shutdown << "' to exit and '" << result <<"' to print the result.\n";
...
double primary()
{
	...
	switch (t.kind)
	{
		...
		case gyok:
			...
			double d = primary();
			if (d < 0)
				error("negative number in squareroot");
			return sqrt(d);
			}
		case power:
			{
